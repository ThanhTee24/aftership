    ...
    $(document).ready(function () {
        $('#my_Table').DataTable({
            ...
            "language": {
                ...
                "infoFiltered": "(lọc trong _MAX_ dòng)",
                ...
                "paginate": {
                    "first": "<i class=\"fa fa-sm fa-fw fa-step-backward\"></i>",
                    "previous": "<i class=\"fa fa-sm fa-fw fa-backward\"></i>",
                    "next": "<i class=\"fa fa-sm fa-fw fa-forward\"></i>",
                    "last": "<i class=\"fa fa-sm fa-fw fa-step-forward\"></i>"
                }
            }
        });
