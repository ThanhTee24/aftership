<div class="card-header flex-wrap py-3">
    ...
    <div class="card-toolbar">
        ...
        <form class="d-flex align-items-center" action="{{route('import')}}" method="post"
            ...
            {{--                                        <button type="button" id="cancelBtn" class="square btn btn-outline-danger"><i class="fa fa-close icon text-btnex d-flex align-items-center justify-content-center">Cancel</i></button>--}}
        </form>
        <script>
